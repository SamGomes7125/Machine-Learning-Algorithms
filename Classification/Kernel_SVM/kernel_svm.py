...
# -*- coding: utf-8 -*-
"""
Kernel SVM Classification Implementation
...
# Feature Scaling (Important for Kernel SVM)
sc = StandardScaler()
X_train = sc.fit_transform(X_train)
X_test = sc.transform(X_test)

# Fitting Kernel SVM to the Training set
classifier = SVC(kernel='rbf', random_state=0)  # Using Radial Basis Function (RBF) kernel
